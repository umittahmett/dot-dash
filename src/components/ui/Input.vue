...
<template>
  <div class="relative">
    <textarea 
      ...
      :class="[
        'py-2 px-4 font-bold bg-white min-h-48 sm:min-h-60 rounded-lg shadow-[0_4px_20px_0_rgba(154, 154, 154, 0.25)] text-black placeholder:text-black/50 text-lg outline-0 resize-none',
        {
